...
if __name__ == "__main__":
    ...
    def shutdown_handler(signum, frame):
        ...
        # SIGKILL the whole process group. Catches the LCD/SPI thread,
        # GStreamer/x264enc helpers spawned by the camera RTSP pipelines,
        # the fuser/modprobe shells from kernel-module reset, the TTS/STT
        # subprocesses, and any other descendants os._exit can't reach.
        try:
